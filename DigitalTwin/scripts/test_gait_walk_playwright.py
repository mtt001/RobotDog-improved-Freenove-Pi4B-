#!/usr/bin/env python3
"""
File: DigitalTwin/scripts/test_gait_walk_playwright.py
Version: v1.7 (2026-02-27 15:48)
Revision History:
- 2026-02-27 15:48 v1.7 - Resolved merge conflict markers and kept effective stability-threshold handling for 2-point support windows.
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--report-json",
        default="/Users/mengtatsai/Freenove_Robot_Dog_Kit_for_Raspberry_Pi/Code/DigitalTwin/logs/HIL_Test_Report.json",
    )
    return p.parse_args()
