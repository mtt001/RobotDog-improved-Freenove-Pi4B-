/*
IMU Viewer Client (Main)
Description:
  Three.js viewer with IMU polling, diagnostics, and offline reminders.
Version:
  2026.02.07-2
Revision History:
...
// Placeholder model (kept if OBJ fails to load)
...
dogGroup.position.y = 0.0;

// Keep camera centered on the body
camera.lookAt(0, 0.8, 0);

// Load colored pug model (OBJ + MTL); fallback to placeholder if load fails.
