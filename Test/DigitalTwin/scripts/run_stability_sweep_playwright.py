#!/usr/bin/env python3
"""
File: Test/DigitalTwin/scripts/run_stability_sweep_playwright.py
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--report-json",
        default="/Users/mengtatsai/Freenove_Robot_Dog_Kit_for_Raspberry_Pi/Code/Test/DigitalTwin/logs/Stability_Sweep_Report.json",
    )
    return p.parse_args()
